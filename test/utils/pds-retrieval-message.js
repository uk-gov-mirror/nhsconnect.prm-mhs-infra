export const testPdsRetrievalMessage = (id, timestamp, receivingAsid, sendingAsid, nhsNumber) => `<QUPA_IN000008UK02 xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3">
    <id root="${id}" />
    ...
    <communicationFunctionRcv>
        <device classCode="DEV" determinerCode="INSTANCE">
            <hl7:id xmlns:SOAP="http://schemas.xmlsoap.org/soap/envelope/" extension="${receivingAsid}" root="1.2.826.0.1285.0.2.0.107" />
        </device>
    </communicationFunctionRcv>
    <communicationFunctionSnd>
        <device classCode="DEV" determinerCode="INSTANCE">
            <hl7:id xmlns:SOAP="http://schemas.xmlsoap.org/soap/envelope/" extension="${sendingAsid}" root="1.2.826.0.1285.0.2.0.107" />
        </device>
    </communicationFunctionSnd>
